<template>
  <div class="ai-rank" style="width: 100%; height: 100%">
    <div class="norem-chartBg">
      <div class="flex flex-row rank-title align-items-center">
        <div
          class="title"
          :class="'list-' + index"
      ...
      <div class="rank-content font-size-14px">
        <div
        ...
        >
          ...
          <div class="list-2"> {{ item.value }}{{ item.unit }} </div>
        </div>
      </div>
    </div>
  </div>
