<template>
  <div class="flex justify-between pagination-container position-absolut el-pagination">
    <div class="flex items-center">
      <div class="el-pagination__total" v-if="queryTime">请求耗时: {{ queryTime }} ms</div>
      <ElPagination
        :size="size"
        v-show="total > 0"
...
const props = defineProps({
  ...
  size: propTypes.string.def('mini')
})
