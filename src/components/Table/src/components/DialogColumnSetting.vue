...
<template>
  <!--   <ElDialog
    ...
    width="300px"
    :modal="false"
    :append-to="props.appendToSelector"
    :show-close="false"
  ...
  <div>
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-between">
        ...
        <ElText class="ml-8px!">列展示</ElText>
      </div>
      <!-- <ElText>固定 / 排序</ElText> -->
    </div>
    <el-scrollbar max-height="280px" :noresize="true">
      <div v-if="settingColumns?.length" style="padding: 0 10px 0 0">
        <VueDraggable
        ...
        >
          ...
          >
            <div
              ...
              :key="item.field"
              class="flex items-center justify-between mt-6px mb-6px"
            >
              <div class="ml-8px cursor-move handle"><Icon icon="ep:rank" /></div>
              <ElCheckbox :label="item.field" width="4rem">
                {{ item.label }}
              </ElCheckbox>
