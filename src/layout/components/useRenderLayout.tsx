...
export const useRenderLayout = () => {
  const renderInIframe = () => {
    return (
      <>
        <div class={[`${prefixCls}-content`, 'absolute top-0 ', 'w-[100%] h-[100%]']}>
          <ElScrollbar
            id="parent-container"
              ...
              {tagsView.value ? (
                <TagsView
                  class={[
                    ...
                    {
                      '!fixed top-1px left-0 z-10': fixedHeader.value,
                      'w-[calc(100%-var(--tab-menu-min-width)-var(--left-menu-max-width))] !left-[var(--tab-menu-min-width)] mt-[var(--logo-height)]':
                        collapse.value && fixedMenu.value && fixedHeader.value,
